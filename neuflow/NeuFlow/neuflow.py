...
from neuflow.NeuFlow import backbone_v7
from neuflow.NeuFlow import transformer
from neuflow.NeuFlow import matching
from neuflow.NeuFlow import corr
from neuflow.NeuFlow import refine
from neuflow.NeuFlow import upsample
from neuflow.NeuFlow import config

# from huggingface_hub import PyTorchModelHubMixin

class NeuFlow(torch.nn.Module):#, repo_url="https://github.com/neufieldrobotics/NeuFlow_v2", license="apache-2.0", pipeline_tag="image-to-image"):
    def __init__(self):
